...
# funtion for the pagination categories
def paginate_category(request, selection):
    ...
    current_category = category[start:end]
...
def create_app(test_config=None):
    ...
    def retrieve_categories():
        ...
        categories = [category.format() for category in my_categories]
        if len(categories) == 0:
            abort(404)
        return jsonify(
            {
        ...
        try:
            ...
            if previous_questions is None:
                ...
                if category == 0:
                    ...
                    questions = Question.query.filter(
                        Question.category==category,Question.id.not_in (previous_questions)
                    )
            ...
            if questions_id != []:
                my_value = random.choice(questions_id)
            else:
                my_value = 0
            ...
            return jsonify(
                {
                    ...
                    # "total_questions_by_category": previous_questions,
                }
            )
