...
class QuizView extends Component {
  ...
  getNextQuestion = () => {
    ...
    $.ajax({
      ...
      crossDomain: true,
      success: (result) => {
        // console.log(result.previous_q)
        // console.log(result.total_questions_by_category)
        if (result.total_questions_by_category === 1){
          this.restartGame()
        }
        this.setState({
          showAnswer: false,
          previousQuestions: previousQuestions,
          currentQuestion: result.question[0],
          guess: '',
  ...
  evaluateAnswer = () => {
    // console.log(this.state.currentQuestion[0].answer)
